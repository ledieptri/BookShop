			...
			<div class="list_product">
				<div class="list_product-info">
					<div class="list_product-info-title">
						<span>SẢN PHẨM</span>
						<form class="sort" action="<c:url value='/home-sortlist'/>"
							method="get" id="sortForm">
							<select name="sortType" id="sortType">
								<option value="desprice">Sắp xếp theo giá tiền giảm dần</option>
								<option value="insprice">Sắp xếp theo giá tiền tăng dần</option>
							</select>
