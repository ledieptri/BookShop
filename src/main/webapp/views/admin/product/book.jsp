...
<c:url var="APIAdminProduct" value="/api-admin-book"/>
<c:url var ="PhoneURL" value="/admin-book"/>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
	...
	<div class="main-content">
		<div class="page-content home-page">
			...
			<div class="ace-settings-container" id="ace-settings-container">
				<!-- -----------------------------------------------------Nút thêm sản phẩm -->
				<a href='<c:url value="/admin-book?type=edit"/>'>
					...
					<table style="font-family: Arial, Helvetica, sans-serif;"
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href='<c:url value="/admin-book?type=edit&productId=${item.productId}"/>'><i id="edit-product" style="color: #438eb9;" class=" icon fas fa-edit"></i></a>                             
